...
public class TestUserDataInformation {
    ...
    public TestUserDataInformation(String userDataInformation, String calculate_word_distance_url) throws IOException, ParseException {
...
//            System.out.println(titleKeyWords.getClaenHtml());
    ...
    public String toString() {
        System.out.println(uid + Constants.SEPARATOR + reqTime + Constants.SEPARATOR + reqURL + Constants.SEPARATOR + titleKeyWords.getTitle()+"dsa");
    ...
    public static void main(String[] args) throws IOException, JSONException, InterruptedException, ParseException {
        ...
        if (Category.categorySuperId == null) {
            Category category = new Category("http://192.168.1.106:8080/public_behavior/api/behavior.do");
            category.init();
        }
        ...
        String s = "20160405114421\t192.168.1.104\t55368\t123.125.115.99\t中医\thttp://baike.baidu.com/view/249882.htm\tGET\tJava/1.7.0_79";
        TestUserDataInformation userDataInformation = new TestUserDataInformation(s,"http://192.168.1.106:8080/zz_nlp/wordsDistance?word1=%s&word2=%s");
        ...
        System.out.println(userDataInformation.toString());
